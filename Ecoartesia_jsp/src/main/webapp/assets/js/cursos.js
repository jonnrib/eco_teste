...
/* ------------------------ Funções para capturar os dados do formulário e enviá-los ao backend ----------------------- */
    function enviarFormulario() {
        ...
        xhr.open("POST", "Contato-create", true);
        xhr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                // Manipular a resposta do servlet, se necessário
                console.log(xhr.responseText);
            }
        };
        xhr.send("nome=" + nome + "&email=" + email + "&telefone=" + telefone + "&mensagem=" + mensagem);
    }
...
/* ------------------------------- Funções para gerenciar a lista e o player de vídeos -------------------------------  */
...
let data = [
  {
    ...
    name: 'assets/vid/Diversidade e inclusão.mp4',
    duration: '0:12',
  },
  {
    id: 'a2',
    title: 'Preparo e Cuidado Com o Solo',
    name: 'assets/vid/Preparo e Cuidado Com o Solo.mp4',
    duration: '1:02',
  },
  {
    id: 'a3',
    title: 'Ações Voluntária de Limpeza',
    name: 'assets/vid/Ações Voluntária de Limpeza.mp4',
    duration: '0:14',
  },
  {
    id: 'a4',
    title: 'Empoderamento e Liderança',
    name: 'assets/vid/Empoderamento e Liderança.mp4',
    duration: '0:08',
  },
  {
    id: 'a5',
    title: 'Permacultura',
    name: 'assets/vid/Permacultura.mp4',
    duration: '0:15',
  },
  {
    id: 'a6',
    title: 'Descarte Consciente',
    name: 'assets/vid/Descarte Consciente.mp4',
    duration: '0:09',
  },
  {
    id: 'a7',
    title: 'Agricultura Sustentável',
    name: 'assets/vid/Agricultura Sustentável.mp4',
    duration: '0:29',
  },
  {
    id: 'a8',
    title: 'Consumo Consciente',
    name: 'assets/vid/Consumo Consciente.mp4',
    duration: '0:04',
  },
  {
    id: 'a9',
    title: 'Direitos Humanos e a Diversidade LGBTQIA+',
    name: 'assets/vid/Direitos Humanos e a Diversidade LGBTQIA.mp4',
    duration: '0:17',
  },
  {
    id: 'a10',
    title: 'A Importância da Liderança na Promoção dos Direitos Humanos e da Igualdade',
    name: 'assets/vid/A Importância da Liderança na Promoção dos Direitos Humanos e da Igualdade.mp4',
    duration: '0:39',
  },
];
