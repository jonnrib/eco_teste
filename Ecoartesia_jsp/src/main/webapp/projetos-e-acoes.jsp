...
<html lang="pt-br">
  <head>
    ...
    <!-- Arquivo CSS -->
    <link rel="stylesheet" href="assets/css/projetos-e-acoes.css" />
    <!-- Ícones -->
  ...
  <body class="d-flex flex-column bg-image">
    ...
    <section class="home">
      ...
      <!-- Conteudo da pagina-->
      <jsp:include page="components/conteudoProjetos.jsp" />
    </section>
    ...
    <!-- Link do JavaScript -->
    <script src="assets/js/projetos-e-acoes.js"></script>
  </body>
</html>